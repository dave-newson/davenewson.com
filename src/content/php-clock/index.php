...
class ClockApp
{
    ...
    function dispatch()
    {
        ...
        $content = $this->renderClock($time);
        $page = $this->renderPage($content);
...
<body>
    ...
    <p>Note: Due to server DDOS protection, you must refresh this page to make the clock tick.</p>

    <pre id="clock">'.$content.'</pre>
</body>
</html>';
